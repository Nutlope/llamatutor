    ...
    messages: [
      {
        role: "system",
        content: `
          You are a helpful assistant that helps the user to ask follow up questions based on the context. Please identify worthwhile questions that can be follow-ups, and write 3 questions no longer than 20 words each. Please make sure that specifics, like events, names, locations, are included in follow up questions so they can be asked standalone.
